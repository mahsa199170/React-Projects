            ...
            <h1>{people.map((person)=>{
                ...
                return (
                   <div key = {id} className="--flex-between --bg-light  --my --card" >
                    ...
                    {/* onClick={()=>removePerson(id)} here for onclick we didint write onClick={reomvePerson(id) cause if we use paranthese after function it will be immediately fired, so thats why we used the arrow function to prevent it from immediately get fired} */}
